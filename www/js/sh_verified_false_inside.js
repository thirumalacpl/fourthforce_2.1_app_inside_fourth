...
//alert(oneemp);
  $('.ssnewinpwe').append('<li><a href="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnewinpwe').append('<li><a href="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.approved_shc').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.approved_shd').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.approved_shb').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.approved_sha').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.approved_she').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.approved_shf').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
