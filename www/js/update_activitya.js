...
var chatr='<br><div class="ui-grid-b"  id="image"><div class="ui-block-a msg_grid_3" style="margin-top: 6%;"> <i class="zmdi zmdi-time zmd-fw" style="    opacity: 0.5; padding-left:7%;"></i><span class="msg_span_3">'+time+'</span><br><span class="msg_span_3">'+date+'</span>  </div><div class="ui-block-b msg_box msg_grid_4 msg_mid_bgg"><p class="msg_grid_p_1 "><a href="#"  class=""><img src="http://staging.eimpressive.com/fourthforce/super/'+activity_lok_obj.document+'" style="width:100px;height:80px;margin-left:25%" alt="Band"></a></p></div><div class="ui-block-c msg_grid_5 msg_grid_5_1"><img src="images/primary/chat-icon.png" alt="" class="p_img_grid" style="width:80px;"><br><p class="p_msg_grid">'+username_tvo+'</p></div></div> '
...
//$.ajax({url: 'http://staging.eimpressive.com/fourthforce/slim-four/dashinprogress.php?region='+region+"&user_id="+user_id,
//alert(region);
//alert(user_id);
$.ajax({url: 'http://staging.eimpressive.com/fourthforce/slim-four/count.php?region='+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/fourthforce/slim-four/lifeint.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&qualification_id="+qualification_id+"&inte="+inte+"&inte_rat="+inte_rat+"&beh="+beh+"&beh_rat="+beh_rat+"&hab="+hab+"&hab_rat="+hab_rat,
