...
// /alert(oneemp);
  $('.ssnewin').append('<li><a href="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnewin').append('<li><a href="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.document_imag_inproone_newbbb').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.document_imag_inproone_newddd').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.document_imag_inproone_newccc').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.document_imag_inproone_newdaaa').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.document_imag_inproone_neweee').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.document_imag_inproone_newfff').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
