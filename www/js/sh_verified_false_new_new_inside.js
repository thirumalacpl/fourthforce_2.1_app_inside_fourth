...
// /alert(oneemp);
  $('.ssnewaa').append('<li><a href="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//$('.document_imag_inproone_newbb').append('<img src="http://staging.eimpressive.com/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
   ...
   $('.newww').append('<li><a href="http://staging.eimpressive.com/fourthforce/uploads/'+one+'"><img src="http://staging.eimpressive.com/fourthforce/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
//$('.s2').append('<li><a href="http://staging.eimpressive.com/fourthforce/uploads/'+one+'"><img src="http://staging.eimpressive.com/fourthforce/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
   $('.newww').append('<li><a href="http://staging.eimpressive.com/fourthforce/uploads/'+one+'"><img src="http://staging.eimpressive.com/fourthforce/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnewaa').append('<li><a href="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.document_imag_inproone_newbb').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.document_imag_inproone_newdd').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.document_imag_inproone_newcc').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.document_imag_inproone_newdaa').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.document_imag_inproone_newee').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.document_imag_inproone_newff').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if(x !== 'New'){
$.ajax({url: "http://staging.eimpressive.com/fourthforce/slim-four/insertbut.php?name="+name+"&verification_user_id="+verification_user_id+"&verification_for="+verification_for+"&current_address="+current_address+"&location="+location+"&state="+state+"&qualification_name="+qualification_name+"&task_name="+task_name+"&type="+type,
...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/fourthforce/slim-four/insertbut.php?name="+name+"&verification_user_id="+verification_user_id+"&verification_for="+verification_for+"&current_address="+current_address+"&location="+location+"&state="+state+"&qualification_name="+qualification_name+"&task_name="+task_name+"&type="+type,
