...
// /alert(oneemp);
  $('.ssnewinpw').append('<li><a href="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnewinpw').append('<li><a href="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.waiting_imagec').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.waiting_imagea').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.waiting_imageb').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.waiting_imaged').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.waiting_imagee').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.waiting_imagef').append('<img src="http://staging.eimpressive.com/fourthforce/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
$.ajax({url: "http://staging.eimpressive.com/fourthforce/slim-four/accept_or_reject.php?accept="+accept+"&verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&region="+region,
...
alert(reject);
document.getElementById('waiting_approve').value = "";
$.ajax({url: "http://staging.eimpressive.com/fourthforce/slim-four/reject_sh.php?reject="+reject+"&verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&region="+region,
    data:$('#accept_or_reject').serialize(),
    type: 'post',                   
    async: 'true',
    crossDomain: true,
